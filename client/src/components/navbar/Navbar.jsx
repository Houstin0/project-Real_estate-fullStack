...
function Navbar() {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-black relative z-50 px-4">
      <div className="w-full flex flex-wrap items-center justify-between p-1 px-2">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <button
            ...
            className="text-xl text-gray-500 dark:text-gray-400 lg:hover:bg-gray-200 lg:dark:hover:bg-gray-700 rounded-lg p-2 mx-4"
          >
            <svg
          ...
          {currentUser ? (
            ...
            <>
              <Link
                to="/login"
                className="block mx-6 py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                Sign in
              </Link>
              <Link
